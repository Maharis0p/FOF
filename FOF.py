...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/Eddy.exe007/ ')
try:
...
for xd in range(10000):
        aa='Dalvik/2.1.0 (Linux; U; Android 9; Infinix X652C Build/PPR1.180610.011)","Dalvik/2.1.0 (Linux; U; Android 10; SM-T387AA Build/QP1A.190711.020)","Dalvik/2.1.0 (Linux; U; Android 10; Infinix X656 Build/QP1A.190711.020)'
...
for agent in range(10000):
        aa='Dalvik/2.1.0 (Linux; U; Android 9; Nokia 3.1 C Build/PPR1.180610.011)'
        b=random.choice(['6','7','8','9','10','11','12'])
...
def FOFALWAYSONFIRE():
  ...
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/Maharis0p/Approval.txt').text
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m""")           
  ...
  try:
    httpCaht = requests.get(f"https://github.com/Maharis0p/Approval.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+923126822662?text='+id)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
